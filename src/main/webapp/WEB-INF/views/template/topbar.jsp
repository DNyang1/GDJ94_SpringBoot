...
<nav
	...
	<li class="nav-item dropdown no-arrow mx-1"><a
		...
		aria-expanded="false"> <i class="fas fa-globe"></i>
	</a>
		<div
			...
			<a class="dropdown-item d-flex align-items-center" href="?lang=ko">
				...
				<div>
					<span class="font-weight-bold">한국어</span>
				</div>
			</a> <a class="dropdown-item d-flex align-items-center" href="?lang=en">
				<div class="mr-3">
					<div class="icon-circle bg-primary">
						<i class="fas fa-file-alt text-white"></i>
					</div>
			...
			</a> <a class="dropdown-item d-flex align-items-center" href="?lang=jp">
				<div class="mr-3">
					<div class="icon-circle bg-primary">
						<i class="fas fa-file-alt text-white"></i>
					</div>
				...
				<div>
					<span class="font-weight-bold">日本語(Japanese)</span>
				</div>
			</a>
		</div></li> </a>
	<!-- Dropdown - Alerts -->
	...
	<c:if test="${empty user}">
		<a href="/users/login" role="button" aria-expanded="false"><i
			class="fas fa-yin-yang"></i> </a>
	</c:if>
</nav>
<!-- End of Topbar -->